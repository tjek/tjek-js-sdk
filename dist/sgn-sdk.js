    ...
    return SGN.request({
      ...
      if (err != null) {
        ...
        if (token !== responseToken) {
          SGN.CoreKit.session.setToken(responseToken);
        }
...
session = {
  ...
  getToken: function() {
    var attrs, ref;
    attrs = (ref = clientCookieStorage.get('session')) != null ? ref : {};
    return attrs.token;
  },
