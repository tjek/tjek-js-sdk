...
keys = ['appVersion', 'appKey', 'appSecret', 'authToken', 'eventTracker', 'locale', 'coreUrl', 'graphUrl', 'eventsTrackUrl', 'assetsFileUploadUrl'];
...
module.exports = function(options, callback) {
  ...
  SGN.CoreKit.session.ensure(function(err) {
    var appSecret, appVersion, clientId, geo, headers, locale, qs, ref, ref1, token;
    if (err != null) {
      return callback(err);
    }
...
session = {
  ...
  callbackQueue: [],
  getUrl: function() {
    return SGN.CoreKit.baseUrl + '/v2/sessions';
  },
  get: function(key) {
    var appKey, ref, ref1;
...
module.exports = function(options, callback, progressCallback) {
  var formData, header, http, key, method, queryParams, ref, ref1, ref2, url, value;
  if (options == null) {
    options = {};
  }
  http = new XMLHttpRequest();
