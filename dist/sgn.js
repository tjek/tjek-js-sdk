...
PagedPublicationHotspots = (function() {
  ...
  PagedPublicationHotspots.prototype.renderHotspots = function(data) {
    ...
    data.hotspots.forEach((function(_this) {
