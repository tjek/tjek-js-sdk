...
function get(key) {
  try {
    ...
    return JSON.parse(storage[_concatInstanceProperty(_context = "".concat(prefixKey)).call(_context, key)]);
  } catch (error) {}
}
function set(key, value) {
  try {
    ...
    storage[_concatInstanceProperty(_context2 = "".concat(prefixKey)).call(_context2, key)] = _JSON$stringify(value);
  } catch (error) {}
}
