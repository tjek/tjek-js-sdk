...
var md5 = require('md5');
var Incito = require('incito-browser');
...
var Verso = require('verso-browser');
...
var Incito__default = /*#__PURE__*/_interopDefaultLegacy(Incito);
...
var Verso__default = /*#__PURE__*/_interopDefaultLegacy(Verso);
...
var Config = /*#__PURE__*/function () {
  function Config() {
    ...
    _defineProperty__default['default'](this, "attrs", {});
  }
  ...
  _createClass__default['default'](Config, [{
    ...
    value: function set() {
      ...
      for (var key in config) {
        ...
        if (_includesInstanceProperty__default['default'](_context = _keysInstanceProperty__default['default'](this)).call(_context, key)) {
...
MicroEvent__default['default'].mixin(Config);
...
function create(callback) {
  ...
  var req = fetch__default['default'](config.get('coreUrl') + _concatInstanceProperty__default['default'](_context = "/v2/sessions?api_key=".concat(key, "&token_ttl=")).call(_context, ttl), {
    method: 'post'
  });
...
function update$1(callback) {
  ...
  var req = fetch__default['default'](config.get('coreUrl') + '/v2/sessions', {
    method: 'put',
    headers: headers
  });
  req.then(function (response) {
...
var Popover = /*#__PURE__*/function () {
  function Popover() {
    ...
    this.keyUp = _bindInstanceProperty__default['default'](_context = this.keyUp).call(_context, this);
    this.resize = _bindInstanceProperty__default['default'](_context2 = this.resize).call(_context2, this);
    this.scroll = _bindInstanceProperty__default['default'](_context3 = this.scroll).call(_context3, this);
...
MicroEvent__default['default'].mixin(Popover);
...
MicroEvent__default['default'].mixin(IncitoPublicationEventTracking);
...
var Viewer = /*#__PURE__*/function () {
  function Viewer(el) {
    ...
    this.el = el;
    this.options = options;
    this.incito = new Incito__default['default'](this.el, {
...
Viewer.Incito = Incito__default['default'];
MicroEvent__default['default'].mixin(Viewer);
...
var Bootstrapper = /*#__PURE__*/function () {
  ...
  _createClass__default['default'](Bootstrapper, [{
    ...
    value: function fetchIncito(id, callback) {
      var res = fetch__default['default'](config.get('coreUrl') + '/v4/rpc/generate_incito_from_publication', {
        method: 'post',
        headers: {
...
var PagedPublicationControls = /*#__PURE__*/function () {
  function PagedPublicationControls(el) {
    ...
    this.destroy = _bindInstanceProperty__default['default'](_context = this.destroy).call(_context, this);
    this.beforeNavigation = _bindInstanceProperty__default['default'](_context2 = this.beforeNavigation).call(_context2, this);
    this.prevClicked = _bindInstanceProperty__default['default'](_context3 = this.prevClicked).call(_context3, this);
    this.nextClicked = _bindInstanceProperty__default['default'](_context4 = this.nextClicked).call(_context4, this);
    this.closeClicked = _bindInstanceProperty__default['default'](_context5 = this.closeClicked).call(_context5, this);
    this.keyDown = _bindInstanceProperty__default['default'](_context6 = this.keyDown).call(_context6, this);
    this.options = options;
    this.els = {
      root: el,
    ...
    _bindInstanceProperty__default['default'](_context7 = this).call(_context7, 'beforeNavigation', this.beforeNavigation);

    _bindInstanceProperty__default['default'](_context8 = this).call(_context8, 'destroyed', this.destroy);
  }
...
MicroEvent__default['default'].mixin(PagedPublicationControls);
...
MicroEvent__default['default'].mixin(PagedPublicationPageSpread);
...
MicroEvent__default['default'].mixin(PagedPublicationPageSpreads);
...
var PagedPublicationCore = /*#__PURE__*/function () {
  function PagedPublicationCore(el) {
    ...
    this.beforeNavigation = _bindInstanceProperty__default['default'](_context = this.beforeNavigation).call(_context, this);
    this.afterNavigation = _bindInstanceProperty__default['default'](_context2 = this.afterNavigation).call(_context2, this);
    this.attemptedNavigation = _bindInstanceProperty__default['default'](_context3 = this.attemptedNavigation).call(_context3, this);
    this.clicked = _bindInstanceProperty__default['default'](_context4 = this.clicked).call(_context4, this);
    this.doubleClicked = _bindInstanceProperty__default['default'](_context5 = this.doubleClicked).call(_context5, this);
    this.pressed = _bindInstanceProperty__default['default'](_context6 = this.pressed).call(_context6, this);
    this.contextmenu = _bindInstanceProperty__default['default'](_context7 = this.contextmenu).call(_context7, this);
    this.panStart = _bindInstanceProperty__default['default'](_context8 = this.panStart).call(_context8, this);
    this.panEnd = _bindInstanceProperty__default['default'](_context9 = this.panEnd).call(_context9, this);
    this.zoomedIn = _bindInstanceProperty__default['default'](_context10 = this.zoomedIn).call(_context10, this);
    this.zoomedOut = _bindInstanceProperty__default['default'](_context11 = this.zoomedOut).call(_context11, this);
    this.resize = _bindInstanceProperty__default['default'](_context12 = this.resize).call(_context12, this);
    this.unload = _bindInstanceProperty__default['default'](_context13 = this.unload).call(_context13, this);
    ...
    _bindInstanceProperty__default['default'](_context14 = this.pageSpreads).call(_context14, 'pageLoaded', _bindInstanceProperty__default['default'](_context15 = this.pageLoaded).call(_context15, this));

    _bindInstanceProperty__default['default'](_context16 = this.pageSpreads).call(_context16, 'pagesLoaded', _bindInstanceProperty__default['default'](_context17 = this.pagesLoaded).call(_context17, this));
    ...
    _bindInstanceProperty__default['default'](_context18 = this).call(_context18, 'started', _bindInstanceProperty__default['default'](_context19 = this.start).call(_context19, this));

    _bindInstanceProperty__default['default'](_context20 = this).call(_context20, 'destroyed', _bindInstanceProperty__default['default'](_context21 = this.destroy).call(_context21, this));
  }
  ...
  _createClass__default['default'](PagedPublicationCore, [{
    ...
    value: function start() {
      ...
      _forEachInstanceProperty__default['default'](_context22 = verso.pageSpreads).call(_context22, _bindInstanceProperty__default['default'](_context23 = this.overridePageSpreadContentRect).call(_context23, this));
    ...
    value: function destroy() {
      ...
      _forEachInstanceProperty__default['default'](_context24 = _Array$from__default['default'](pageSpreadEls)).call(_context24, function (pageSpreadEl) {
    ...
    value: function createVerso() {
      var verso = new Verso__default['default'](this.els.verso, {
        pageId: this.pageId
      });
    ...
    value: function renderPageSpreads() {
      ...
      _forEachInstanceProperty__default['default'](_context25 = this.getVerso().pageSpreads).call(_context25, function (pageSpread) {
        ...
        if (match) {
          if (visibility === 'visible' && match.contentsRendered === false) {
            ...
            _setTimeout__default['default'](_bindInstanceProperty__default['default'](_context26 = match.renderContents).call(_context26, match), 0);
          }

          if (visibility === 'gone' && match.contentsRendered === true) {
            var _context27;

            _setTimeout__default['default'](_bindInstanceProperty__default['default'](_context27 = match.clearContents).call(_context27, match), 0);
          }
        }
      });
    ...
    value: function findPage(pageId) {
      ...
      return _findInstanceProperty__default['default'](_context28 = this.getOption('pages')).call(_context28, function (page) {
    ...
    value: function switchPageMode(pageMode) {
      ...
      _forEachInstanceProperty__default['default'](_context29 = _Array$from__default['default'](pageSpreadEls)).call(_context29, function (pageSpreadEl) {
        pageSpreadEl.parentNode.removeChild(pageSpreadEl);
      });
      ...
      _forEachInstanceProperty__default['default'](_context30 = verso.pageSpreads).call(_context30, _bindInstanceProperty__default['default'](_context31 = this.overridePageSpreadContentRect).call(_context31, this));
...
MicroEvent__default['default'].mixin(PagedPublicationCore);
...
var PagedPublicationEventTracking = /*#__PURE__*/function () {
  function PagedPublicationEventTracking(eventTracker, id) {
    ...
    _bindInstanceProperty__default['default'](_context = this).call(_context, 'appeared', _bindInstanceProperty__default['default'](_context2 = this.appeared).call(_context2, this));

    _bindInstanceProperty__default['default'](_context3 = this).call(_context3, 'disappeared', _bindInstanceProperty__default['default'](_context4 = this.disappeared).call(_context4, this));

    _bindInstanceProperty__default['default'](_context5 = this).call(_context5, 'beforeNavigation', _bindInstanceProperty__default['default'](_context6 = this.beforeNavigation).call(_context6, this));

    _bindInstanceProperty__default['default'](_context7 = this).call(_context7, 'afterNavigation', _bindInstanceProperty__default['default'](_context8 = this.afterNavigation).call(_context8, this));

    _bindInstanceProperty__default['default'](_context9 = this).call(_context9, 'attemptedNavigation', _bindInstanceProperty__default['default'](_context10 = this.attemptedNavigation).call(_context10, this));

    _bindInstanceProperty__default['default'](_context11 = this).call(_context11, 'panStart', _bindInstanceProperty__default['default'](_context12 = this.panStart).call(_context12, this));

    _bindInstanceProperty__default['default'](_context13 = this).call(_context13, 'destroyed', _bindInstanceProperty__default['default'](_context14 = this.destroy).call(_context14, this));
  }
  ...
  _createClass__default['default'](PagedPublicationEventTracking, [{
    ...
    value: function pageSpreadDisappeared() {
      if (this.pageSpread && this.hidden === false) {
        ...
        this.trackPageSpreadDisappeared(_mapInstanceProperty__default['default'](_context15 = this.pageSpread.getPages()).call(_context15, function (page) {
...
MicroEvent__default['default'].mixin(PagedPublicationEventTracking);
...
var PagedPublicationHotspots = /*#__PURE__*/function () {
  function PagedPublicationHotspots() {
    ...
    _bindInstanceProperty__default['default'](_context = this).call(_context, 'hotspotsReceived', _bindInstanceProperty__default['default'](_context2 = this.hotspotsReceived).call(_context2, this));

    _bindInstanceProperty__default['default'](_context3 = this).call(_context3, 'afterNavigation', _bindInstanceProperty__default['default'](_context4 = this.afterNavigation).call(_context4, this));

    _bindInstanceProperty__default['default'](_context5 = this).call(_context5, 'pagesLoaded', _bindInstanceProperty__default['default'](_context6 = this.pagesLoaded).call(_context6, this));

    _bindInstanceProperty__default['default'](_context7 = this).call(_context7, 'resized', _bindInstanceProperty__default['default'](_context8 = this.resized).call(_context8, this));
  }
  ...
  _createClass__default['default'](PagedPublicationHotspots, [{
    ...
    value: function renderHotspots(data) {
      ...
      _forEachInstanceProperty__default['default'](_context9 = _Array$from__default['default'](hotspotEls)).call(_context9, function (hotspotEl) {
    ...
    value: function getPosition(pages, ratio, hotspot) {
      ...
      for (var pageNumber in hotspot.locations) {
        ...
        _forEachInstanceProperty__default['default'](_context10 = hotspot.locations[pageNumber]).call(_context10, function (coords) {
...
MicroEvent__default['default'].mixin(PagedPublicationHotspots);
  ...
  _createClass__default['default'](Viewer, [{
    ...
    value: function processHotspotQueue() {
      ...
      this.hotspotQueue = _filterInstanceProperty__default['default'](_context34 = this.hotspotQueue).call(_context34, function (hotspotRequest) {
        ...
        var versoPageSpread = _findInstanceProperty__default['default'](_context35 = _this3._core.getVerso().pageSpreads).call(_context35, function (pageSpread) {
...
MicroEvent__default['default'].mixin(Viewer$1);
