...
| data-component-paged-publication-viewer-offer-click-behavior | `shopping_list` (default) : Offer will be added to shopping list<br/> `redirect_to_webshop_link` : Clicking an offer will redirect to webshop link; Shopping list will be disabled automatically<br/>`open_webshop_link_in_tab` : Clicking an offer will open webshop link in new tab; Shopping list will be disabled automatically |
| data-component-paged-publication-disable-shopping-list       | `false` (default)<br/> `true`                                                                                                                                                                                                                                                                                                       |
| data-component-paged-publication-disable-close               | `false` (default)<br/> `true`                                                                                                                                                                                                                                                                                                       |
| data-component-paged-publication-disable-menu                | `false` (default)<br/> `true`                                                                                                                                                                                                                                                                                                       |
| data-component-paged-publication-disable-download            | `false` (default)<br/> `true`                                                                                                                                                                                                                                                                                                       |
| data-component-paged-publication-disable-header              | `false` (default)<br/> `true`                                                                                                                                                                                                                                                                                                       |
| data-component-list-publications-filter                      | eg: `all_stores:true,r_lat:59.9139,r_lng:10.7522` <br/> key:value and is separated by comma                                                                                                                                                                                                                                         |
