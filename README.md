...
| data-component-publication-disable-pagedecorations     | `false` (default)<br/> `true`                                                                                                                                                                                                                                                                                                                                                                       |
...
| data-component-list-publications-request-filter        | eg: `r_lat:59.9139,r_lng:10.7522` <br/>eg: `tags:weekly catalog` <br/> Filter on request level - key:value and is separated by comma                                                                                                                                                                                                                                                                |
