...
export default class TouchInput extends Input {
    ...
    getTouches(ev, type) {
        ...
        // merge and unique targetTouches with changedTargetTouches so it contains ALL touches, including 'end' and 'cancel'
        const usedTouches = [];
        return [
            targetTouches
                ...
                .filter((item) => {
                    ...
                    usedTouches.push(val);

                    return usedTouches.indexOf(val) < 0;
                })
