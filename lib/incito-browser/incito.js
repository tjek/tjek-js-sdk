...
export default class Incito {
    ...
    renderView(view) {
        ...
        if (view.view_name === 'TextView') {
            ...
            attrs.sandbox = 'allow-scripts allow-same-origin allow-modals';
            attrs['data-src'] = view.src;
        ...
        if (isDefinedStr(view.link)) {
            ...
            // TODO: window.open(view.link, '_blank');
        }
        ...
        if (isDefinedStr(view.background_image)) {
            ...
            attrs['data-src'] = view.background_image;
        }
