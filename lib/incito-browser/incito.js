...
export default class Incito extends MicroEvent {
    ...
    loadEl(el) {
        ...
        } else if (el.classList.contains('incito__incito-embed-video')) {
    ...
    renderView(view) {
        ...
        } else if (view.view_name === 'IncitoEmbedVideo') {
            classNames.push('incito__incito-embed-video');
            
            if (this.canLazyload) {
                classNames.push('incito--lazy');

                attrs['data-src'] = view.src;
                attrs['data-method'] = view.method || 'get';
