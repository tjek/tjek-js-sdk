...
if (isBrowser()) {
    ...
    if (scriptEl) {
        ...
        if (pubController === 'view-publication') {
            const pagedPublicationTemplate = new SGN.CoreUIKit.PagedPublication(
                scriptEl
            );
        ...
        if (pubController === 'list-publications') {
            const listPublicationsTemplate = new SGN.CoreUIKit.ListPublications(
                scriptEl
            );

            listPublicationsTemplate.render();
        }
    }
}
