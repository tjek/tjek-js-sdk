...
const pagedPublication = (scriptEl, mainContainer = '') => {
    ...
    const renderMainContainer = () => {
        ...
        PagedPublicationComponents.MainContainer({
            ...
            shoppingListCounterTemplate: _customTemplates.shoppingListCounter,
            el: mainContainerEl,
        ...
        setOptions: async (options = {}) => {
            _options = {
                ...
                id:
                    ...
                    '',
                dealerId: options.dealerId || _scriptEls.businessId
            };
            ...
            bootstrapper.fetch((err, data) => {
                if (!err) {
                    ...
                    bootstrapper.fetchHotspots((err2, hotspots) => {
                        if (!err2) {
                            bootstrapper.applyHotspots(_viewer, hotspots);
                        }
                    });
                } else {
                    console.error(err);
                ...
                request(
                    {
                        url: '/v2/catalogs',
                        qs: {
                            dealer_id: _scriptEls.businessId,
