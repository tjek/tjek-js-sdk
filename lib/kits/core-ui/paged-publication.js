...
export default class PagedPublication {
    constructor(scriptEl, mainContainer = '') {
        ...
        this.scriptEls = {
            ...
            storeLatitude: scriptEl.getAttribute(
                'data-component-paged-publication-store-latitude'
            ),
            storeLongitude: scriptEl.getAttribute(
                'data-component-paged-publication-store-longitude'
            )
        };
        ...
        this.customTemplates = {
            ...
            storeList: document.getElementById(
                'sgn-sdk-paged-publication-viewer-store-list-template'
            ),
    ...
    renderMainContainer() {
        ...
        const mainContainer = new PagedPublicationComponents.MainContainer({
            ...
            shoppingCounterTemplate: this.customTemplates.shoppingCounter,
            el: mainContainerEl,
            scriptEls: this.scriptEls
        });
    ...
    renderStoreList() {
        const storeList = new PagedPublicationComponents.StoreList({
            configs: this.options,
            template: this.customTemplates.storeList,
            scriptEls: this.scriptEls
        });
        storeList.render();
    }
