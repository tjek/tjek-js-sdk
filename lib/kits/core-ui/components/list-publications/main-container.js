...
<div class="sgn__publications">
    <ul class="sgn-publications-ul">
        {{#publications}}
        <li class="sgn-publications-li">
            <div class="publications__item" data-id="{{id}}">
                <div class="sgn-publications-li-div-img">
                    <img data-id="{{id}}" src="{{images.view}}" alt="{{label}}">
                </div>
                <div class="sgn-publications-li-div-text">
                    <div class="sgn-publications-li-heading">
                        <span>{{label}}</span>
                    </div>
                    <div class="sgn-publications-li-date">
