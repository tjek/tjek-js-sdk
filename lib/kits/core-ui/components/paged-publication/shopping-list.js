    ...
    <div class="sgn-shopping-popup">
        <div class="sgn-popup-header">
            <div class="sgn-popup-header-label">
                <span>{{translations.paged_publication_viewer_shopping_list_label}}</span>
            </div>            
        ...
        <ol class="sgn-shopping-ol">
                ...
                <div class="sgn-shopping-li-flex-container">
                    <div class="sgn-shopping-li-div-text">
                        <div class="sgn-shopping-li-div-text-heading sgn-truncate-elipsis">
                            <span>{{translations.paged_publication_viewer_currency_prefix}}{{price}} {{translations.paged_publication_viewer_currency_suffix}} - {{name}}</span><br/>
                        </div>
                    </div>
                </div>
            </li>
            ...
            <li class="sgn-shopping-li-crossed sgn-hide-print">
                <button class="sgn-shopping-clear-ticked-list-btn sgn-hide-print">{{translations.paged_publication_viewer_delete_crossed_out_button}}</button>
            </li>
            {{/hasTicked}}
        </ol>
        <div>
            <button class="sgn-shopping-clear-list-btn sgn-hide-print">{{translations.paged_publication_viewer_clear_list_button}}</button>
            <button class="sgn-shopping-print-list-btn sgn-hide-print">{{translations.paged_publication_viewer_print_button}}</button>
        </div>
    </div>\
`;

const shoppingList = ({template, scriptEls}) => {
    ...
    const _translations = {
        paged_publication_viewer_shopping_list_label: translate(
            _scriptEls.localeCode,
            'paged_publication_viewer_shopping_list_label'
        ),
        paged_publication_viewer_currency_prefix: translate(
            _scriptEls.localeCode,
            'paged_publication_viewer_currency_prefix'
        ),
        paged_publication_viewer_currency_suffix: translate(
            _scriptEls.localeCode,
            'paged_publication_viewer_currency_suffix'
        ),
        paged_publication_viewer_delete_crossed_out_button: translate(
            _scriptEls.localeCode,
            'paged_publication_viewer_delete_crossed_out_button'
        ),
        paged_publication_viewer_clear_list_button: translate(
            _scriptEls.localeCode,
            'paged_publication_viewer_clear_list_button'
        ),
        paged_publication_viewer_print_button: translate(
            _scriptEls.localeCode,
            'paged_publication_viewer_print_button'
        )
    };
    ...
    const formatListToShare = (data = []) => {
        ...
        notTicked.forEach((offer) => {
            notTickedStr += `[] ${_translations.paged_publication_viewer_currency_prefix}${offer.price} ${_translations.paged_publication_viewer_currency_suffix} - ${offer.name}\n`;
        });

        ticked.forEach((offer) => {
            notTickedStr += `[x] ${_translations.paged_publication_viewer_currency_prefix}${offer.price} ${_translations.paged_publication_viewer_currency_suffix} - ${offer.name}\n`;
        });
