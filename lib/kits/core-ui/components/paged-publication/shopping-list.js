            ...
            <li class="sgn-shopping-li">
                <div class="sgn-shopping-li-flex-container">
                    <div class="sgn-shopping-li-div-text">
                        ...
                        <div class="sgn-shopping-li-div-text-description">
                            <span>{{offer.pricing.price}} kr. </span>
                        </div>
                    </div>
                    <div class="sgn-shopping-li-div-btn sgn-hide-print">
                        <div class="sgn-shopping-remove-item">
                            <button class="sgn-shopping-remove-item-btn" data-id="{{index}}">Remove</button>
                        </div>
                    </div>
