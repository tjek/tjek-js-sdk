...
export default class ShoppingList extends ComponentHelpers {
    ...
    addRemoveItemListener() {
        const removeBtns = this.container.querySelectorAll(
    ...
    addPrintListener() {
        const printBtn = this.container.querySelector(
            '.sgn-shopping-print-list'
        );
