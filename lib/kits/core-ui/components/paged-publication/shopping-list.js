    ...
    <div class="sgn-shopping-popup">
        ...
        <ol class="sgn-shopping-ol">
                ...
                <div class="sgn-shopping-li-flex-container">
                    <div class="sgn-shopping-li-div-text">
                        <div class="sgn-shopping-li-div-text-heading sgn-truncate-elipsis">
                            <span>{{translate.currencyPrefix}}{{price}} {{translate.currencySuffix}} - {{name}}</span><br/>
                        </div>
                    </div>
                </div>
            </li>
            ...
            <li class="sgn-shopping-li-crossed sgn-hide-print">
                <button class="sgn-shopping-clear-ticked-list-btn sgn-hide-print">{{translate.deleteCrossedOutItems}}</button>
            </li>
            {{/hasTicked}}
        </ol>
        <div>
            <button class="sgn-shopping-clear-list-btn sgn-hide-print">{{translate.clearList}}</button>
            <button class="sgn-shopping-print-list-btn sgn-hide-print">{{translate.print}}</button>
        </div>
    </div>\
`;
...
const shoppingList = ({template, scriptEls}) => {
    ...
    const _locale = localization[_scriptEls.countryCode];
    ...
    const formatListToShare = (data = []) => {
        ...
        notTicked.forEach((offer) => {
            notTickedStr += `[] ${_locale.translate.currencyPrefix}${offer.price} ${_locale.translate.currencySuffix} - ${offer.name}\n`;
        });

        ticked.forEach((offer) => {
            notTickedStr += `[x] ${_locale.translate.currencyPrefix}${offer.price} ${_locale.translate.currencySuffix} - ${offer.name}\n`;
        });
