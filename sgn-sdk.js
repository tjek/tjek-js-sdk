...
var initialize = function initialize() {
  ...
  var data, fetch, fetchHotspots, fetchPages, getSelectedHotspot, hotspotPicker, hotspotQueue, hotspots, processHotspotQueue, render, transformPages, viewer;
  data = {
    details: null,
    pages: null,
    hotspots: null
  ...
  fetchPages = function fetchPages(callback) {
    var ref;
  ...
  fetchHotspots = function fetchHotspots(callback) {
    var ref;
  ...
  render = function render() {
    ...
    viewer.bind('clicked', function (e) {
      getSelectedHotspot(e, function (hotspot) {
    ...
    viewer.bind('pressed', function (e) {
      getSelectedHotspot(e, function (hotspot) {
    ...
    if (!((ref1 = options.data) != null ? ref1.pages : void 0)) {
      viewer.trigger('pagesFetched', data.pages);
    }
    if (data.hotspots && !((ref2 = options.data) != null ? ref2.hotspots : void 0)) {
      viewer.trigger('hotspotsFetched', Object.keys(data.hotspots).map(function (key) {
        return data.hotspots[key];
      }));
    }
  };
  transformPages = function transformPages(pages) {
  ...
  processHotspotQueue = function processHotspotQueue() {
